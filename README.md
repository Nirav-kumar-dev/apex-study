...
Apex Study OS can be run as a native Android application!

- **Android Project**: [`android/`](android)
- **1-Click Windows APK Builder**: Double-click **[`build-apk.bat`](build-apk.bat)**
- **Android Studio**: Run `npm run cap:open` to open the native project in Android Studio.
- **Detailed Instructions**: See **[`ANDROID_GUIDE.md`](ANDROID_GUIDE.md)** for complete APK generation and device installation steps.
