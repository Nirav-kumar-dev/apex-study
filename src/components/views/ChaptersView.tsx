...
export const ChaptersView: React.FC<ChaptersViewProps> = ({
  ...
  const { chapters, subjects, currentDate, incrementQuestionsSolved, addChapter, setActiveView } = useApp();
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
            Track syllabus completion, solved question banks, and retention confidence
          </p>
        </div>
